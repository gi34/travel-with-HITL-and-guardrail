...
def run_travel_agent(user_input: str, thread_id: str| None = None):
    ...
    # run the travel-agent graph, starts from flight_agent -> hotel_agent -> itinerary_agent -> final_agent
    # store the output in result, pass the initial travel state and configuration (thread_id) into the graph
    '''
